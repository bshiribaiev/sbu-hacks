...
function ScenePage() {
    ...
    const displayCase = selectedChild ? {
        ...selectedChild,
        modelUrl: buildModelUrl(availableScenes.find((s)=>s.id === selectedChildId), availableScenes.find((s)=>s.id === selectedCaseId))
    } : selectedCase;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2f25edbe._.js.map